...
@Entity
@Table(name = "TableOffresStage",uniqueConstraints = {@UniqueConstraint(columnNames = "typeoffres")})
...
public class OffresStage extends EmploiOffres implements Serializable {
	...
	public OffresStage(Long id,String titre,String description,String diplome,String connaissance,
